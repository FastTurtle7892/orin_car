...
# NODES = {
#     "ORIGIN_GOAL": {'x': -1.09631, 'y': 2.88533, 'yaw': -1.57},
#     "NODE_1_COORD": {'x': -0.70318, 'y': 1.3719,  'yaw': -1.13443},
#     "NODE_2_COORD": {'x': -1.02715, 'y': 1.94344, 'yaw': -1.03699},
#     "NODE_3_COORD": {'x': 0.20307, 'y': 0.34701, 'yaw': -1.11063},
#     "NODE_4_COORD": {'x': 0.40307,  'y': -0.99442, 'yaw': -1.57}
# }
...
#     "NODE_1_COORD": {'x': -0.70318, 'y': 1.3719,  'yaw': -1.13443},
#     "NODE_2_COORD": {'x': -1.02715, 'y': 1.94344, 'yaw': -1.03699},
#     "NODE_3_COORD": {'x': 0.00307, 'y': 0.34701, 'yaw': -1.11063},
#     "NODE_4_COORD": {'x': 0.40307,  'y': -0.99442, 'yaw': -1.57},
#     "NODE_5_COORD": {'x': -0.906,  'y': -2.4, 'yaw': 0.0},
#     "NODE_6_COORD": {'x': 0.79,  'y': -2.4, 'yaw': 0.0},
#     "NODE_7_COORD": {'x': -1.04,  'y': -1.3, 'yaw': 1.57},
# }
# # 생성할 경로 목록 (출발지 -> 도착지)
# PATH_SEQUENCE = [
...
#     ("NODE_3_COORD", "NODE_4_COORD"),
#     ("NODE_4_COORD", "NODE_5_COORD"),
#     ("NODE_5_COORD", "NODE_6_COORD"),
#     ("NODE_6_COORD", "NODE_7_COORD"),
# ]

NODES = {
    "ORIGIN_GOAL": {'x': -0.678518, 'y': 2.78053, 'yaw': -1.58},
    "NODE_1_COORD": {'x': -0.212045, 'y': 1.49575,  'yaw': -0.97292},
    "NODE_2_COORD": {'x': -1.08907, 'y': 1.86821, 'yaw': -0.987572},
    "NODE_3_COORD": {'x': 0.00307, 'y': 0.34701, 'yaw': -1.12063},
    "NODE_4_COORD": {'x': 0.10307,  'y': -0.79442, 'yaw': -1.57},
    "NODE_5_COORD": {'x': -0.406,  'y': -2.8, 'yaw': -1.9},
    "NODE_6_COORD": {'x': 1.29,  'y': -1.5, 'yaw': 0.0},
    "NODE_7_COORD": {'x': -1.04,  'y': 0.1, 'yaw': 1.57},
}


# 생성 순서 (이 순서대로 하나씩 그리게 됩니다)
PATH_SEQUENCE = [
    ("ORIGIN_GOAL", "NODE_1_COORD"),
    ("NODE_1_COORD", "NODE_2_COORD"),
    ("NODE_2_COORD", "NODE_3_COORD"),
...
# 이거 할때는 maps2/my_map2.pgm 사용
# my_map2.pgm 할때 살짝만 곡선 내리기
# NODES = {
#     "ORIGIN_GOAL":   {'x': -0.615, 'y': 2.56,  'yaw': -1.57},
#     "NODE_1_COORD":  {'x': -0.397, 'y': 1.178, 'yaw': -0.97},
#     "NODE_2_COORD":  {'x': -0.665, 'y': 1.564, 'yaw': -0.97},
#     "NODE_3_COORD":  {'x': 0.940,   'y': 0.04, 'yaw': 0.00},
#     "NODE_4_COORD":  {'x': -0.314613,   'y': 0.04, 'yaw': 0.00}
# }
...
SAVE_DIR = os.path.expanduser("~/trailer_paths2") # 저장할 폴더
